...
function App() {
  return (
    <div className="max-w-[1344px] mx-auto flex flex-col items-center mt-20">
      ...
      <div className='self-stretch mt-8 pt-1 bg-nlw-gradient rounded-lg'>
        <div className='bg-[#2A2634] px-8 py-6 rounded-md flex justify-between items-center'>
          ...
          <button className='py-3 px-4 bg-violet-500 hover:bg-violet-600 rounded-md text-white flex gap-3 items-center'>
